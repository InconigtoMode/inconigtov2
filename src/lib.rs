    ...
    <div class="container">
        <div class="card">
            <div class="profile-header">
                ...
                <h1 class="profile-name">Inconigto Mode</h1>
            ...
            <div class="footer-credit">
                ...
                <p>Powered by <i class="fas fa-heart" style="color: #ff6b6b;"></i> by <a href="https://t.me/Inconigto_Mode" target="_blank">Inconigto Mode</a> </p>
            </div>
        </div>
    </div>
